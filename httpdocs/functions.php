  ...
  ?>
  	<div class="header-full-width">
       ...
       <div class="right">
            ...
            <div class="language">
            	<div class="left"><img src="<?=get_bloginfo('stylesheet_directory'); ?>/images/header-txt.png" /></div>
            	<div class="right">
                	<div class="lang"></div>
...
function news_gallery(){
    ...
    <div class="bottomFrame">
    	<div class="news">
        	<h2><span><?php _e('NEWS','tourofcrete');?>:</span><?php _e('UPDATE','tourofcrete');?></h2>
    	...
    	<div class="gallery">      	
            ...
            <a href="#" class="more"><?php _e('More Photos','tourofcrete');?> ></a>
            
            <div style="padding:18px 0 0 57px; clear:both;">
		<?php
		global $wpdb;
		$pictures = $wpdb->get_results("SELECT * FROM wp_ngg_pictures WHERE galleryid = '1' ORDER BY imagedate");
		$i=1;
